...
## That will evaluate the strength of a password based on certain criteria. 12/15/2025
## UPDATE - This has become an intermediate projet that now includes a GUI and an encrypted password vault. 06/06/2024
import random
import string
import colorama
...
## The following function checks the strength of the password based on certain criteria.
...
## The word list can be expanded to include more options.
...
## If the password provided was not strong, the following prompt will appear
